    ...
    def withdraw(self, account):
        ...
        if account > self.balance:
            ...
            if self.free_withdrawals >= 0:
                return super().withdraw(account)
            else:
                return super().withdraw(account + self.withdraw_fee)
